...
// source: https://github.com/MrJul/Estragonia/blob/main/src/JLeb.Estragonia/VkDeviceApi.cs
// author: MrJul
// License: MIT

/// <summary>
/// Provides access to Vulkan device-level functions loaded via vkGetDeviceProcAddr.
/// Used for pipeline barrier operations required for Skia-Godot GPU texture sharing.
/// </summary>
internal sealed unsafe class VkDeviceApi
{
    ...
    public void CreateCommandPool(VkDevice device, ref VkCommandPoolCreateInfo pCreateInfo, IntPtr pAllocator, out VkCommandPool pCommandPool)
    ...
    public void AllocateCommandBuffers(VkDevice device, ref VkCommandBufferAllocateInfo pAllocateInfo, VkCommandBuffer* pCommandBuffers)
